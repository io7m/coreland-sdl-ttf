...
instchk instchk.o insthier.o sdl-ttf-ada-conf sdl-ttf-ada-conf.o sdl-ttf-ada.a \
...
sdl-ttf-ada-conf:\
cc-link sdl-ttf-ada-conf.ld sdl-ttf-ada-conf.o ctxt/ctxt.a
	./cc-link sdl-ttf-ada-conf sdl-ttf-ada-conf.o ctxt/ctxt.a

sdl-ttf-ada-conf.o:\
cc-compile sdl-ttf-ada-conf.c ctxt.h
	./cc-compile sdl-ttf-ada-conf.c
...
obj_clean:
	...
	installer installer.o instchk instchk.o insthier.o sdl-ttf-ada-conf \
	sdl-ttf-ada-conf.o sdl-ttf-ada.a sdl-ttf.ali sdl-ttf.o
ext_clean:
